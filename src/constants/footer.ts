...
export const FOOTER_BUTTON_HOME = 'Главная';
export const FOOTER_BUTTON_SEARCH = 'Поиск';
export const FOOTER_BUTTON_RECORD = 'Записать';
export const FOOTER_BUTTON_MY_PROFILE = 'Мой профиль';
